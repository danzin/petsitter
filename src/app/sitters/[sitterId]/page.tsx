...
type SitterProfileData = PetSitter & {
    user: Pick<User, 'id' | 'name' | 'email' | 'image' | 'location' | 'bio'>;

};

async function getDataById(sitterId: string): Promise<SitterProfileData> {
    if (!sitterId) {
    ...
    return sitter as SitterProfileData;
}
              ...
              <div className="lg:col-span-2 space-y-6">
                  ...
                  {/* Reviews arent ready yet */}
                   <Card>
                      ...
                      <CardContent>
                           <p className="text-muted-foreground">(Full reviews section coming soon.)</p>
                      </CardContent>
                  </Card>
